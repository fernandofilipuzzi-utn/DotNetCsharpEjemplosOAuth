        ...
        <div class="col-12">
            ...
            <div class="col-12 m-3" style="background-color: #dcdced;">
                ...
                <div class="form-group row p-2">
                    ...
                    <div class="col-9">
                        <div class="row">
                            <asp:TextBox ID="tbIdCredencial" CssClass="form-control text-muted form-control-lg col-12" Text="" runat="server" Enabled="false" placeholder="Id credencial" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row p-2">
                    ...
                    <div class="col-9">
                        <div class="row">
                            <asp:TextBox ID="tbGuidCredencial" MaxLength="50" CssClass="form-control form-control-lg col-12" Text="" runat="server" placeholder="GUID Generado" />
                        </div>
